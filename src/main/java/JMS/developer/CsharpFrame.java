...
public class CsharpFrame extends JFrame implements IDeveloperFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater((new Runnable() {
            public void run() {
                try {
                    CsharpFrame frame = new CsharpFrame();
    ...
    public CsharpFrame() {
        developerBrokerGateway = new DeveloperBrokerGateway("C#");

        setTitle("Developer - C#");
