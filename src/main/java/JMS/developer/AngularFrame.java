...
public class AngularFrame extends JFrame implements IDeveloperFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater((new Runnable() {
            public void run() {
                try {
                    AngularFrame frame = new AngularFrame();
    ...
    public AngularFrame() {
        developerBrokerGateway = new DeveloperBrokerGateway("Angular");

        setTitle("Developer - Angular");
